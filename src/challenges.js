...
function highestCount(array) {
  ...
  // Definindo a variável "temp" como a primeira posição do array para que caso um array de números negativos seja entrado, o valor padrão (0) da variável vazia não interfira na comparação.
  let temp = array[0];
